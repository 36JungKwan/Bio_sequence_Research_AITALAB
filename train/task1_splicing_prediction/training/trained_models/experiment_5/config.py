...
EPOCHS = 50
PATIENCE = 7
NUM_WORKERS = 8  # Số worker process để load data song song
PIN_MEMORY = True  # Pin memory để tăng tốc độ transfer
USE_MIXED_PRECISION = True  # Sử dụng float16 để giảm memory và tăng speed
